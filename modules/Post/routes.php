...
Route::group(['module' => 'Post', 'namespace' => 'Modules\Post\Controllers'], function () {
    ...
    Route::group(['middleware' => ['web']], function () {
        Route::get('bai-viet/{slug}', 'WebController@getDetailPost')->name('mod_post.web.detail_post');
        Route::get('danh-muc/{slug}', 'WebController@viewCategory')->name('mod_post.web.view_category');
    });
});