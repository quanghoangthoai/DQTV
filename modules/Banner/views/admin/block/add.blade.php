    ...
    <table class="table table-bordered table-td-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" class="form-control input-inline" name="width" value="{{ old('width') }}" placeholder="Rộng" style="width:120px">
                    x
                    <input type="number" class="form-control input-inline" name="height" value="{{ old('height') }}" placeholder="Cao" style="width:120px">
                </td>
            </tr>
            <tr>
