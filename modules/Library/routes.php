...
Route::group(['module' => 'Library', 'namespace' => 'Modules\Library\Controllers'], function () {
    ...
    Route::group(['middleware' => ['web', 'auth'], 'prefix' => 'clients'], function () {
        ...
        Route::get('/detail-history-download/{id}', 'ClientController@getDetailHistoryDownload')->name('client.detail_history_download');
        Route::get('download/{id}', 'WebController@getDownload')->name('mod_library.web.get_download');
    });
});