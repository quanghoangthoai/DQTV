        ...
        <div class="col-md-4 p-0">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <select class="form-control" id="document-category-select" name="category_id">
                            <option value="">Chọn danh mục</option>
                            @if ($listCat && count($listCat) > 0)
                            @foreach ($listCat as $k => $iCategory)
                            <option data-id="{{ $iCategory['format_type'] }}" value="{{ $iCategory['id'] }}" {{ old('category_id') == $iCategory['id'] ? 'selected' : '' }}>{{$iCategory['prefix']}} {{ $iCategory['name'] }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <select class="form-control" id="document-type-select" name="document_type">
                            ...
                            <option data-type="{{ $value['type'] }}" value="{{ $value['id'] }}" {{ old('document_type') == $value['id'] ? 'selected' : '' }}>{{ $value['name'] }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
