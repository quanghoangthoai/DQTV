...
<form action="{{ route('cms.admin.postsetting_info') }}" method="post">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-3"><strong>Tên đơn vị</strong> <sup class="text-danger">(*)</sup></label>
            <div class="col-lg-9">
                <input placeholder="Nhập tên website" type="text" name="site_unit" class="form-control" value="{{ old('site_name', cms_get_config('site_name')) }}">
            </div>
        </div>
        <div class="form-group row">
